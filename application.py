...
def callback():  
  ...
  try:
    ...
    cell="UNINFECTED" if result[0][1]==1 else "PARASITIZED"
    output.set("\n "+cell+" CELL DETECTED !\n");print(cell)
  except:
...
background = PhotoImage(file="Bvp.png")
...
l = Label(root, text = "College Final Year Project")
l.config(font =("Bauhaus 93", 40))
l.pack()
